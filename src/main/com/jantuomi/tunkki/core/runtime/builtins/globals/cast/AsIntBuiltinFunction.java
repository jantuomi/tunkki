        ...
        switch (param.getType()) {
            case String:
                try {
                    ...
                    throw new TunkkiError(TunkkiError.ExceptionType.CastError, -1, "Integer", ((StringDatatype) param).getData());
                }
            ...
            default:
                throw new TunkkiError(TunkkiError.ExceptionType.CastError, -1, "Integer", param.toString());
        }
